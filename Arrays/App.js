...
// console.log(cars); //obje tipindedir.
...
// console.log(cars3); //eski bir yapi ve tavsiye edilmiyor
...
// const cars = ["Opel", , "Audi", "BMW"] //empty eleman virgul kullanilarak olusturulabilir.
...
// console.log('' + fruits); // arrayi stringe cevirdi
...
// console.log(num.sort((a, b) => a - b)); // numara olarak siralar.
// console.log(num.sort((a, b) => b - a)); // numara olarak siralar. tersten siralar.
...
// console.log(fruits.pop()); // her sildigini bize gosterir
// console.log(fruits.pop()); // her sildigini bize gosterir
// console.log(fruits.pop()); // her sildigini bize gosterir
